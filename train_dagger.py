...
parser = argparse.ArgumentParser(description="JOSE G1 DAgger policy distillation")
...
from jose.estimator.models import (
    DaggerStudent,
    ReplayBuffer,
    RunningNormalizer,
    dagger_beta,
...
def main(env_cfg, agent_cfg):
    ...
    log_dir = Path(args_cli.log_dir or f"logs/jose_g1/dagger/{timestamp}").resolve()

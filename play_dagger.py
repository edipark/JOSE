...
parser = argparse.ArgumentParser(description="JOSE G1 DAgger student play")
...
parser.add_argument("--video-dir", default="logs/jose_g1/videos/dagger")
...
from jose.estimator.models import DaggerStudent, RunningNormalizer
from jose.schema import G1_JOINT_NAMES, SCHEMA_VERSION
...
def main():
    ...
    if checkpoint.get("jose_schema_version") != SCHEMA_VERSION or checkpoint.get("kind") != "dagger_student":
        raise ValueError("Only JOSE schema-v2 DAgger student checkpoints are supported")

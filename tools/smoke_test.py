"""One-environment smoke test for every registered JOSE G1 task."""
...
parser.add_argument(
    "--task",
    choices=("amp_walk", "amp_dance", "amp_jump", "locomotion"),
    default="amp_walk",
...
TASKS = {
    ...
    "locomotion": ("Isaac-G1-PPO-Walk-Estimator-JOSE-v0", 495),
}
...
def main():
    ...
    env.close()
    print(f"PASS {task}: obs={observation_dim}, action=29, estimator=58->{estimator_dim}", flush=True)
